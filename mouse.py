...
def speak_intro():
    ...
    engine.say('Welcome to the Handless Computer Control, please read the following'
                ', How to use the app'
...
pyautogui.alert('Welcome to the Handless Computer Control, PLEASE READ THE FOLLOWING.\n'
               'How to use the app:\n'
               'To exit the app, press q.\n'
               'Turn your face left, right, up or down to control the mouse accordingly.\n'
               'To left click, shut your left eye.\n'
               ...
               'Both the mouse and keyboard apps will be opened after this message.\n'
               'Enjoy!\n',
               'Welcome!', button='Ok', timeout=45000) # close the message box after 30 seconds
